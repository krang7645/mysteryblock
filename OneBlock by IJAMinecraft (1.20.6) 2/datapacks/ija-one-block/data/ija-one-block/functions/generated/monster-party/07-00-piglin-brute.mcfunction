...
execute as @s at @s run summon minecraft:piglin_brute ~ ~1.6 ~ {"ArmorItems":[{"id":"minecraft:golden_boots","count":1},{"id":"minecraft:golden_leggings","count":1},{"id":"minecraft:golden_chestplate","count":1},{"id":"minecraft:golden_helmet","count":1}],"HandItems":[{"id":"minecraft:golden_axe","count":1},{}],"Tags":["ija-a4-new-mob"],"CustomName":"{\"translate\":\"ija.oneblock.tl.27\",\"fallback\":\"Monster Guard\",\"color\":\"dark_red\"}"}
