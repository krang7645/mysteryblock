...
execute as @s at @s run summon minecraft:bee ~ ~1.6 ~ {"AngerTime":3600,"Tags":["ija-a4-new-mob"],"CustomName":"{\"translate\":\"ija.oneblock.tl.27\",\"fallback\":\"Monster Guard\",\"color\":\"dark_red\"}"}
execute as @s at @s run summon minecraft:bee ~ ~1.6 ~ {"AngerTime":3600,"Tags":["ija-a4-new-mob"],"CustomName":"{\"translate\":\"ija.oneblock.tl.27\",\"fallback\":\"Monster Guard\",\"color\":\"dark_red\"}"}
