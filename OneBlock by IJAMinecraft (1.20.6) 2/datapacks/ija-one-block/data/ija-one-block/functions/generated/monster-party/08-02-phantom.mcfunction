...
execute as @s at @s run summon minecraft:phantom ~ ~1.6 ~ {"active_effects":[{"id":"minecraft:fire_resistance","amplifier":1,"duration":2147483647,"show_particles":false}],"Tags":["ija-a4-new-mob"],"CustomName":"{\"translate\":\"ija.oneblock.tl.27\",\"fallback\":\"Monster Guard\",\"color\":\"dark_red\"}"}
